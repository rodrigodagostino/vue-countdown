...
.progress-ring-container {
	...
	padding: 1rem;
	border-radius: 50%;
	box-shadow: -1rem -1rem 1.5rem 0.125rem rgba(255, 255, 255, 0.6), inset 1px 1px 1px rgba(255, 255, 255, 0.6),
		inset -1px -1px 1px rgba(0, 0, 0, 0.05), 1rem 1rem 1.5rem 0.125rem rgba(0, 0, 0, 0.15);
}
...
.progress-ring {
	...
	&__track-inner-shadow {
		box-shadow: -2px -2px 4px 1px rgba(255, 255, 255, 0.6), inset 1px 1px 1px rgba(255, 255, 255, 0.6),
			inset -1px -1px 1px rgba(0, 0, 0, 0.05), 2px 2px 4px 1px rgba(0, 0, 0, 0.1);
	}
